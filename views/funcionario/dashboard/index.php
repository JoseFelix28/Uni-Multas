...
<head>
    ...
    <link rel="stylesheet" href="<?php echo constant('URL'); ?>public/css/functionaryDashboard.css">
        ...
        <div class="nav-menu">
            ...
            <div class="div2 navigation sub-menu">
                ...
                <ul>
                    ...
                    <li class="list <?php echo $pagina ==  'NuevaMulta' ? 'active' : ''; ?>">
                        <a href="?p=nuevaMulta">
                    ...
                    <li class="list <?php echo $pagina ==  'history' ? 'active' : ''; ?>">
                        <a href="?p=history">
                            <span id="boton" class="text">Historico de Multas</span>
                            <span class="icon ">
