                ...
                <div class="container-all" id="Registrarse">
                    ...
                    <div class="popup">
                        <form action=""  class="formulario__register">
                            <input type="text" autocomplete="off" class="nameUser" name="name" value="<?= isset($name) ? $name : ''; ?>" placeholder="Nombre">
                            ...
                            <input type="text" autocomplete="off" class="username" name="username" placeholder="Usuario">
                            <input type="password" autocomplete="off" class="password" name="password" placeholder="Contraseña">
                            ...
                            <input type="submit" class="registro" id="enviar" value="Registrar">
                        </form>
...
<script const url=location.href;  >

$('#enviar').click(function(){
    var name=document.getElementById('name').value;
    var sndName=document.getElementById('sndName').value;
    ...
    var nLicense=document.getElementById('nLicense').value;
    var typeLicense=document.getElementById('typeLicense').value;
    var gender=document.getElementById('gender').value;
    var country=document.getElementById('country').value;

    var route="name"+name+"&sndName"+sndName+"&lastName"+lastName+"&nationalID"+
    DNI+"&mailAddress"+mailAddress+"&username"+username+"&password"+password+"&passwordVerify"
    +passwordVerify+"&nLicense"+nLicense+"&typeLicense"+typeLicense+"&gender"+gender+"&country"+country;
